...
public class tileManager {
    ...
    public void loadMap() {
        ...
        int[][] predefinedMap = {
                {1, 1, 1, 9, 1, 9, 1, 1, 1, 1, 1, 1, 9, 9, 7, 9, 1, 9, 1, 1},
                {1, 4, 4, 4, 4, 4, 4, 4, 4, 7, 4, 4, 4, 4, 4, 4, 4, 4, 4, 9},
                {1, 1, 1, 9, 1, 1, 1, 4, 4, 5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 1},
                {9, 2, 2, 2, 2, 2, 1, 4, 4, 5, 4, 4, 4, 2, 2, 2, 4, 4, 4, 1},
                {1, 2, 2, 2, 2, 0, 1, 4, 4, 5, 4, 3, 4, 2, 2, 2, 4, 4, 4, 1},
                {1, 2, 2, 2, 2, 2, 1, 4, 4, 5, 4, 4, 4, 2, 2, 2, 4, 4, 4, 1},
                {9, 2, 2, 2, 2, 2, 1, 4, 4, 5, 4, 4, 4, 4, 4, 4, 3, 4, 4, 1},
                {1, 1, 1, 6, 9, 1, 1, 3, 4, 5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 9},
